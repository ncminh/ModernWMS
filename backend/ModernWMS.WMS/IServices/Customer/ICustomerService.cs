...
namespace ModernWMS.WMS.IServices
{
    ...
    public interface ICustomerService : IBaseService<CustomerEntity>
    {
        ...
        /// <param name="currentUser">currentUser</param>
        /// <returns></returns>
        Task<CustomerViewModel> GetAsync(int id, CurrentUser currentUser);
        /// <summary>
        /// add a new record
        /// </summary>
        ...
        /// <param name="currentUser">currentUser</param>
        /// <returns></returns>
        Task<(bool flag, string msg)> UpdateAsync(CustomerViewModel viewModel, CurrentUser currentUser);
